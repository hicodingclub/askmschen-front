...
@Component({
  selector: 'app-mpicturegroup-edit',
  templateUrl: './mpicturegroup-edit.component.html',
  styleUrls: ['./mpicturegroup-edit.component.css']
})
export class MpicturegroupEditComponent extends MpicturegroupEditCustComponent implements OnInit, AfterViewInit {
  // @Input() 
  // public id: string;
  // @Input()

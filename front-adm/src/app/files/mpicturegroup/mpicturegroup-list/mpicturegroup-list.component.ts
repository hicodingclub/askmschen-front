...
export class MpicturegroupListComponent extends MpicturegroupListCustComponent implements OnInit {
  public minDate = {
  ...
  static getInstance() {
    ...
    return new MpicturegroupListComponent(null, null, null, null, null);
  }
}
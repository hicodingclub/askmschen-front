...
@Component({
  selector: 'app-mpicturegroup-detail-sel',
  templateUrl: './mpicturegroup-detail-sel.component.html',
  styleUrls: ['./mpicturegroup-detail.component.css']
})
export class MpicturegroupDetailSelComponent extends MpicturegroupDetailComponent
implements OnInit {
  // @Input() inputData;
  // @Output() outputData;

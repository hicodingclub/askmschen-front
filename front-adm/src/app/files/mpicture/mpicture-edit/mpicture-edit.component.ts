...
@Component({
  selector: 'app-mpicture-edit',
  templateUrl: './mpicture-edit.component.html',
  styleUrls: ['./mpicture-edit.component.css']
})
export class MpictureEditComponent extends MpictureEditCustComponent implements OnInit, AfterViewInit {
  // @Input() 
  // public id: string;
  // @Input()

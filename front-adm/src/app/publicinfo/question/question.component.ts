...
export class QuestionComponent extends MddsBaseComponent implements OnInit {
  // *** common input fields
  @Input()
  public style: any; // {}
  @Input()
  ...
  constructor(public questionService: QuestionService, public injector: Injector, public router: Router, public route: ActivatedRoute, public location: Location) {
    ...
    this.requiredFields = ['name', 'email', 'question', ];
    this.emailFields = [
      ['Email', 'email'],
    ];
    this.schemaName = 'question';

...
export class SubscriptionListComponent extends SubscriptionListCustComponent implements OnInit {
  ...
  static getInstance() {
    ...
    return new SubscriptionListComponent(null, null, null, null, null);
  }
}
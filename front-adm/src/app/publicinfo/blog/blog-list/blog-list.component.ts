...
export class BlogListComponent extends BlogListCustComponent implements OnInit {
  public minDate = {
  ...
  constructor(public blogService: BlogService, public injector: Injector, public router: Router, public route: ActivatedRoute, public location: Location) {
    ...
    this.stringBoxFields = ['title', ];
    this.ownSearchFields = ['publishDate', 'topicTags', 'hot', ];
  ...
  static getInstance() {
    ...
    return new BlogListComponent(null, null, null, null, null);
  }
}
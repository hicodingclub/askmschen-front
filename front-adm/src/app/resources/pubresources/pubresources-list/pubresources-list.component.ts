...
export class PubresourcesListComponent extends PubresourcesListCustComponent implements OnInit {
  public minDate = {
  ...
  static getInstance() {
    ...
    return new PubresourcesListComponent(null, null, null, null, null);
  }
}
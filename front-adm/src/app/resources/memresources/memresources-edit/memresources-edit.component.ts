...
@Component({
  selector: 'app-memresources-edit',
  templateUrl: './memresources-edit.component.html',
  styleUrls: ['./memresources-edit.component.css']
})
export class MemresourcesEditComponent extends MemresourcesEditCustComponent implements OnInit, AfterViewInit {
  // @Input() 
  // public id: string;
  // @Input()

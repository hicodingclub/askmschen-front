...
export class MpubpermissionListViewComponent implements OnInit {
  ...
  @Input() cardHasLink: boolean = false;
  @Input() canUpdate: boolean = true;
  @Input() canDelete: boolean = true;
  @Input() canArchive: boolean = true;
  @Input() canCheck: boolean = true;
  @Input() includeSubDetail: boolean = true;
  @Input() cardHasSelect: boolean = false;

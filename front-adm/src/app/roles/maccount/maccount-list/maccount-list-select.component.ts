...
@Component({
  ...
  styleUrls: ['./maccount-list.component.css', './maccount-list-select.component.css']
})
export class MaccountListSelectComponent extends MaccountListComponent implements OnInit {

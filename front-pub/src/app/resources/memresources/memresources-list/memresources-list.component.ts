...
export class MemresourcesListComponent extends MemresourcesListCustComponent implements OnInit {
  public minDate = {
  ...
  static getInstance() {
    ...
    return new MemresourcesListComponent(null, null, null, null, null);
  }
}